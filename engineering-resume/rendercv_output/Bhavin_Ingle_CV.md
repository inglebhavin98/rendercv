...
- Secured ₹5L grant from Department of Science & Technology (Govt. of India) and NSRCEL (IIM Bangalore) incubator; filed 3 provisional patents for an IoT product, ranking as a Top 60 Finalist team nationally among 100k+ applicants.
...
- Implemented an **Orchestrator-Worker pattern** running Chain-of-Thought (CoT) and few-shot prompting over multi-LLM router pipelines (via OpenRouter), successfully mapping ~70 high-frequency, complex healthcare journeys onto intelligent conversational steering bots.
...
Directed product engineering from inception to MVP launch (June 2018 – Aug 2020) before transitioning to a strictly non-operational advisory role; appointed as Director during corporate restructuring from OPC to Pvt. Ltd. in May 2021.
...
# Publications
## **Implementation of Virtual OPC on Cloud**

2019



[10.1109/TENCON.2019.8929398](https://doi.org/10.1109/TENCON.2019.8929398) (IEEE Region 10 Conference - TENCON)



## **Aquaculture Monitoring and Feedback System**

2019



[10.1109/iSES47678.2019.00082](https://doi.org/10.1109/iSES47678.2019.00082) (IEEE International Symposium on Smart Electronic Systems -iSES)
